...
The jupyter notebook 'Spectrum 2017 Puebla Mexico earthquake.ipynb' includes the code for plotting the spectrum. It uses [plotly](https://plotly.com/python/) to get intearctive graphs.
